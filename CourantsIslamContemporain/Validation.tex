...
\paragraph{L’argument mutualiste – ta awuni ou tabaduli\sn{What does \TArabe{ تبادلي }(tabaduli) mean in Arabic?}
...
L’argent comparé à une semence qui fructifie : Thomas d’Aquin,…. En clair, pour Thomas d’Aquin l’argent prêté qui ne peut porter intérêt et reste stérile se distingue de l’argent qui est placé et sert à un investissement.
 ...
 \paragraph{naissance capitalisme genevois}
 \begin{quote}
...
published his 1967 dissertation entitled, \textit{Gharar: Impact on Contract in Islamic Fiqh}\sn{Siddīq Muḥammad al-Amīn al-Ḍarīr, Gharar: Impact on Contract in Islamic Fiqh
...
\subsection{The Conceptualization of Uncertainty}
\begin{quote}
...
uncertainty is from the perspective of jurists.
 ...
 mort : ok: lit de mort : non ok (car asymétrie d'information)
