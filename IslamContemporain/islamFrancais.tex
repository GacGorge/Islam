...
\begin{figure}
    \centering
    \includegraphics{ImageIslamFrance/OrigineSociale.png}
...
\begin{figure}
    \centering
    \includegraphics{ImageIslamFrance/Diplome.png}
    \caption{Diplômes détenus par les enquêtés}
    \label{fig:my_label}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics{ImageIslamFrance/Emploi.png}
