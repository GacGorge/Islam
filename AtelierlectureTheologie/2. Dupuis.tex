...
\mn{Reconstruire la problématique}

\paragraph{Thèse ou hypothèse} Le dialogue : Ni à côté de la mission, ni ne remplaçant la mission. la pratique porte du fruit. \mn{il ne s'agit pas de résumer. Il y a une méthode. }.

\paragraph{Argumentation} ici distinction des concepts. \mn{Le plan permet parfois de voir l'argumentation} D'ailleurs dans les titres. Argumentation théologique : il s'agit de clarifier les concepts et lien théologique. Lien surtout avec le magistère récent \mn{importance du lien avec les sources de la foi}.
Trois documents
...
\paragraph{Dans le magistère} le Règne de Dieu, c'est l'unité de l'humanité, par l'action du Christ. JPII, qui intègre l'ES dans la théologie missionnaire : p 547 : "l'idée que l'Esprit agit dans toute l'humanité". 'unité achève toute sanctification' (Prière Eucharistique).
p. 556 : DA... Dupuis veut articuler le rôle de l'Eglise mais comme signe du Royaume. 
\mn{la raison,... fondement...}
