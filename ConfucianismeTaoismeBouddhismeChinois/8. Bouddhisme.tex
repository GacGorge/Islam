...
\begin{figure}[!h]
    \centering
    \sidecaption{Voyage de Faxian, Dominique LELIÈVRE, Voyageurs chinois à la découverte du monde– De l’Antiquité au XIXe siècle, Genève: Éditions OLIZANE, 2004, p. 58.c}    \includegraphics[width=.5\textwidth]{ConfucianismeTaoismeBouddhismeChinois/Images/XuanzangVoyage2.jpg}
...
\begin{figure}
    \centering
        \sidecaption{Mont Tiantai}
    \includegraphics[width=1\textwidth]{ConfucianismeTaoismeBouddhismeChinois/Images/Mont Tiantai 1.png}
    

    \label{fig:enter-label}
\end{figure}

 \paragraph{La doctrine du Tiantai - La Triple vérité :}
 \begin{itemize}
     \item   
