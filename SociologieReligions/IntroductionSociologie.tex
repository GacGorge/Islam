...
\end{itemize} 
La question de départ, c'est le fil directeur, les autres questions vont apparaître mais risque de s'éparpiller.
\end{Ex}
...
\item Intermédiaires ?
\iitem comment est on après la converions ?
\end{itemize}
...
\mn{la grille d'entretien permet une approche scientifique.  mettre à plat les comportements. } \sn{Stephane Beaud et Florence Weber : \textit{Guide de l'enquête de Terrain}, livre accessible }

\item avez vous changé de pratiques alimentaire ? {où achetez vous ? voir les accommodements ?}
...
\item BOLTANSKI Luc et Ève CHIAPELLO, Le nouvel esprit du capitalisme, Paris,  Gallimard, coll. « NRF essais », 1999. 
\item DUBET François, À quoi sert vraiment un sociologue ?, Armand Colin, coll. « Dites-  nous », 2011. - Le Déclin de l'institution, Le Seuil, coll. « L'Épreuve des faits », septembre 2002. 
...
\item PIETTE Albert (http://www.albertpiette.net), Le Fait religieux. Une théorie de la religion  ordinaire, Paris, Economica, 2003. 
\item TRIGANO Shmuel, Qu’est-ce que la religion ? La transcendance des sociologues, Paris,   Flammarion, 2001 
\item BAUBEROT Jean, Les sept laïcités françaises. Le modèle français de laïcité n'existe pas,  Paris, Maison des Sciences de l'Homme, 2015 
...
\item proposez des hypothèses (réponses à la question de départ)\sn{le document final doit garder la trace de ces hypothèses. }
\item une partie réflexivité peut constituer la conclusion: quelles étaient mes prénotions sur ce sujet au début ? Qu’ai-je découvert ? Qu’est-ce qui m’a surpris ?\sn{C'est rare qu'on arrive à la fin à tous nos présupposés}
